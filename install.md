# Covid Proyect Latam guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `covid_proyect_latam/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `covid_proyect_latam` folder and use the modules inside your notebooks :
...
```python
from covid_proyect_latam.utils.paths import data_dir
data_dir()
```
